...
dictConfig = {
    ...
    "GALAXY_ARRAY": {
        ...
        'tag'    : ['PREIRR'],
        'meas'   : ["W_MAX","L_MAX","LMAXVAR","T_MAX_1","T_MAX_2","T_MAX_3"], 
    ...
    "TOFPET_ARRAY" : {
        ...
        'tag' : ['PREIRR','GREASE'],
        'meas': ['LY_MEAN_1','LY_MEAN_2','LY_MEAN_3','LY_RSTD_1','LY_RSTD_2','LY_RSTD_3','SIGMA_T_MEAN_1','SIGMA_T_MEAN_2','SIGMA_T_MEAN_3','SIGMA_T_RSTD_1','SIGMA_T_RSTD_2','SIGMA_T_RSTD_3','XT_MEAN_1','XT_MEAN_2','XT_MEAN_3','XT_RSTD_1','XT_RSTD_2','XT_RSTD_3'],
    ...
    "TOFPET_BARINARRAY" : {
        ...
        'tag' : ['PREIRR','GREASE'],
        'meas': ['SIGMA_T_1','SIGMA_T_2','SIGMA_T_3','XT_1','XT_2','XT_3'],
...
dictMeas = {
    ...
    "L_MEAN"   : {'db_name': 'L_MEAN'   , 'xmin':54.85, 'xmax':55.15, 'thr':[54.97,55.03], 'label':'Single Xtal Length'       , 'unit':'[mm]'   , 'DrawHisto' :True, 'type_sel':['1','2','3']},
    "W_MEAN"   : {'db_name': 'W_MEAN'   , 'xmin': 3.00, 'xmax': 3.24, 'thr':[ 3.09, 3.15], 'label':'Single Xtal Width'        , 'unit':'[mm]'   , 'DrawHisto' :True, 'type_sel':['1','2','3']},
    "T_MEAN"   : {'db_name': 'T_MEAN'   , 'xmin': 2.85, 'xmax': 3.15, 'thr':[ 2.97, 3.03], 'label':'Single Xtal Thickness'    , 'unit':'[mm]'   , 'DrawHisto' :True, 'type_sel':['1','2','3']},
   
    # Single xtal optical properties
    "LO"       : {'db_name': 'LO'       , 'xmin':3750 , 'xmax':7000 , 'thr':[4000,999999], 'label':'Single Xtal Light Output', 'unit':'[ph/MeV]'   , 'DrawHisto' :True, 'type_sel':['1','2','3']},
    "DT"       : {'db_name': 'DECAY_TIME', 'xmin':30  , 'xmax':50   , 'thr':[-1, 45]     , 'label':'Decay Time'              , 'unit':'[ns]'       , 'DrawHisto' :True, 'type_sel':['1','2','3']},
    "LOoverDT" : {'db_name': 'LOoverDT' , 'xmin':80   , 'xmax':160  , 'thr':[105,9999999], 'label':'LO/DT'                   , 'unit':'[ph/MeV/ns]', 'DrawHisto' :True, 'type_sel':['1','2','3']},
    "LO_RSTD"  : {'db_name': 'LO_RSTD'  , 'xmin':0.00 , 'xmax':15.00, 'thr':[-1, 10]     , 'label':'LO relative std. dev.'   , 'unit':'(%)'        , 'DrawHisto' :False, 'type_sel':['1','2','3']},
    "DT_RSTD"  : {'db_name': 'DT_RSTD'  , 'xmin':0.00 , 'xmax':15.00, 'thr':[-1,  5]     , 'label':'DT relative std. dev.'   , 'unit':'(%)'        , 'DrawHisto' :False, 'type_sel':['1','2','3']},
    "LOoverDT_RSTD": {'db_name': 'LOoverDT_RSTD', 'xmin':0, 'xmax':15, 'thr':[-1, 5]     , 'label':'LO/DT relative std. dev.', 'unit':'(%)'        , 'DrawHisto' :False, 'type_sel':['1','2','3']},

    # Array Dimensions
    "L_MAX"    : {'db_name': 'L_MAX'    , 'xmin':54.75, 'xmax':55.25, 'thr':[54.95,55.05], 'label':'Length'                  , 'unit':'[mm]', 'DrawHisto' :True, 'type_sel':['1','2','3']},
    "LMAXVAR"  : {'db_name': 'LMAXVAR'  , 'xmin': 0.00, 'xmax': 0.07, 'thr':[-1.00, 0.05], 'label':'Planarity'               , 'unit':'[mm]', 'DrawHisto' :True, 'type_sel':['1','2','3']},
    "W_MAX"    : {'db_name': 'W_MAX'    , 'xmin':50.88, 'xmax':52.08, 'thr':[51.38,51.58], 'label':'Width'                   , 'unit':'[mm]', 'DrawHisto' :True, 'type_sel':['1','2','3']},
    "T_MAX_1"  : {'db_name': 'T_MAX'    , 'xmin': 3.91, 'xmax': 4.31, 'thr':[ 4.01, 4.21], 'label':'Thickness (type #1)'     , 'unit':'[mm]', 'DrawHisto' :True, 'type_sel':['1']    },
    "T_MAX_2"  : {'db_name': 'T_MAX'    , 'xmin': 2.86, 'xmax': 3.76, 'thr':[ 3.26, 3.46], 'label':'Thickness (type #2)'     , 'unit':'[mm]', 'DrawHisto' :True, 'type_sel':['2']    },
    "T_MAX_3"  : {'db_name': 'T_MAX'    , 'xmin': 2.26, 'xmax': 3.26, 'thr':[ 2.66, 2.86], 'label':'Thickness (type #3)'     , 'unit':'[mm]', 'DrawHisto' :True, 'type_sel':['3']    },
    # Bar in array optical properties
    "BARLENGTH": {'db_name': 'BARLENGTH', 'xmin':54.85, 'xmax':55.15, 'thr':[54.95,55.05], 'label':'Length'                  , 'unit':'[mm]', 'DrawHisto' :True, 'type_sel':['1','2','3']},

    # Array optical properties
    "LY_MEAN_1"  : {'db_name': 'LY_MEAN'  , 'xmin':3750 , 'xmax':7000 , 'thr':[4000,9999999], 'label':'Array Light Output (type #1)' , 'unit':'[ph/MeV]', 'DrawHisto' :True, 'type_sel':['1']},
    "LY_MEAN_2"  : {'db_name': 'LY_MEAN'  , 'xmin':3750 , 'xmax':7000 , 'thr':[4000,9999999], 'label':'Array Light Output (type #2)' , 'unit':'[ph/MeV]', 'DrawHisto' :True, 'type_sel':['2']},
    "LY_MEAN_3"  : {'db_name': 'LY_MEAN'  , 'xmin':3750 , 'xmax':7000 , 'thr':[4000,9999999], 'label':'Array Light Output (type #3)' , 'unit':'[ph/MeV]', 'DrawHisto' :True, 'type_sel':['3']},
    "LY_RSTD_1"  : {'db_name': 'LY_RSTD'  , 'xmin': 0.00, 'xmax':10.00, 'thr':[ 0.00,  7.00], 'label':'Light Yield RMS (type #1)'    , 'unit':'(%)' , 'DrawHisto' :True, 'type_sel':['1']},
    "LY_RSTD_2"  : {'db_name': 'LY_RSTD'  , 'xmin': 0.00, 'xmax':10.00, 'thr':[ 0.00,  7.00], 'label':'Light Yield RMS (type #2)'    , 'unit':'(%)' , 'DrawHisto' :True, 'type_sel':['2']},
    "LY_RSTD_3"  : {'db_name': 'LY_RSTD'  , 'xmin': 0.00, 'xmax':10.00, 'thr':[ 0.00,  7.00], 'label':'Light Yield RMS (type #3)'    , 'unit':'(%)' , 'DrawHisto' :True, 'type_sel':['3']},
    "SIGMA_T_MEAN_1": {'db_name':'SIGMA_T_MEAN', 'xmin':90, 'xmax':150, 'thr':[ 0.00,140.00], 'label':'Time resolution (type #1)'    , 'unit':'[ps]', 'DrawHisto' :True, 'type_sel':['1']},
    "SIGMA_T_MEAN_2": {'db_name':'SIGMA_T_MEAN', 'xmin':90, 'xmax':150, 'thr':[ 0.00,140.00], 'label':'Time resolution (type #2)'    , 'unit':'[ps]', 'DrawHisto' :True, 'type_sel':['2']},
    "SIGMA_T_MEAN_3": {'db_name':'SIGMA_T_MEAN', 'xmin':90, 'xmax':150, 'thr':[ 0.00,140.00], 'label':'Time resolution (type #3)'    , 'unit':'[ps]', 'DrawHisto' :True, 'type_sel':['3']},
    "SIGMA_T_RSTD_1": {'db_name':'SIGMA_T_RSTD', 'xmin': 0, 'xmax':10., 'thr':[ 0.00,  6.00], 'label':'Time resolution RMS (type #1)', 'unit':'(%)' , 'DrawHisto' :True, 'type_sel':['1']},
    "SIGMA_T_RSTD_2": {'db_name':'SIGMA_T_RSTD', 'xmin': 0, 'xmax':10., 'thr':[ 0.00,  6.00], 'label':'Time resolution RMS (type #2)', 'unit':'(%)' , 'DrawHisto' :True, 'type_sel':['2']},
    "SIGMA_T_RSTD_3": {'db_name':'SIGMA_T_RSTD', 'xmin': 0, 'xmax':10., 'thr':[ 0.00,  6.00], 'label':'Time resolution RMS (type #3)', 'unit':'(%)' , 'DrawHisto' :True, 'type_sel':['3']},
    "XT_MEAN_1"  : {'db_name': 'XT_MEAN'  , 'xmin': 0.00, 'xmax': 0.30, 'thr':[ 0.00,  0.25], 'label':'Cross Talk (type #1)'         , 'unit':''    , 'DrawHisto' :True, 'type_sel':['1']},
    "XT_MEAN_2"  : {'db_name': 'XT_MEAN'  , 'xmin': 0.00, 'xmax': 0.30, 'thr':[ 0.00,  0.25], 'label':'Cross Talk (type #2)'         , 'unit':''    , 'DrawHisto' :True, 'type_sel':['2']},
    "XT_MEAN_3"  : {'db_name': 'XT_MEAN'  , 'xmin': 0.00, 'xmax': 0.30, 'thr':[ 0.00,  0.25], 'label':'Cross Talk (type #3)'         , 'unit':''    , 'DrawHisto' :True, 'type_sel':['3']},
    "XT_RSTD_1"  : {'db_name': 'XT_RSTD'  , 'xmin': 0.00, 'xmax':50.00, 'thr':[ 0.00, 40.00], 'label':'Cross Talk RMS (type #1)'     , 'unit':'(%)' , 'DrawHisto' :True, 'type_sel':['1']},
    "XT_RSTD_2"  : {'db_name': 'XT_RSTD'  , 'xmin': 0.00, 'xmax':50.00, 'thr':[ 0.00, 40.00], 'label':'Cross Talk RMS (type #2)'     , 'unit':'(%)' , 'DrawHisto' :True, 'type_sel':['2']},
    "XT_RSTD_3"  : {'db_name': 'XT_RSTD'  , 'xmin': 0.00, 'xmax':50.00, 'thr':[ 0.00, 40.00], 'label':'Cross Talk RMS (type #3)'     , 'unit':'(%)' , 'DrawHisto' :True, 'type_sel':['3']},
    # Bar in array
    "SIGMA_T_1"  : {'db_name': 'SIGMA_T'  , 'xmin':90   , 'xmax':150  , 'thr':[ 0.00,140.00], 'label':'Time resolution (type #1)', 'unit':'[ps]', 'DrawHisto' :True, 'type_sel':['1']},
    "SIGMA_T_2"  : {'db_name': 'SIGMA_T'  , 'xmin':90   , 'xmax':150  , 'thr':[ 0.00,140.00], 'label':'Time resolution (type #2)', 'unit':'[ps]', 'DrawHisto' :True, 'type_sel':['2']},
    "SIGMA_T_3"  : {'db_name': 'SIGMA_T'  , 'xmin':90   , 'xmax':150  , 'thr':[ 0.00,140.00], 'label':'Time resolution (type #3)', 'unit':'[ps]', 'DrawHisto' :True, 'type_sel':['3']},
    "XT_1"       : {'db_name': 'XT'       , 'xmin': 0.00, 'xmax': 0.30, 'thr':[ 0.00,  0.25], 'label':'Cross Talk (type #1)'     , 'unit':''    , 'DrawHisto' :True, 'type_sel':['1']},
    "XT_2"       : {'db_name': 'XT'       , 'xmin': 0.00, 'xmax': 0.30, 'thr':[ 0.00,  0.25], 'label':'Cross Talk (type #2)'     , 'unit':''    , 'DrawHisto' :True, 'type_sel':['2']},
    "XT_3"       : {'db_name': 'XT'       , 'xmin': 0.00, 'xmax': 0.30, 'thr':[ 0.00,  0.25], 'label':'Cross Talk (type #3)'     , 'unit':''    , 'DrawHisto' :True, 'type_sel':['3']},
}
...
for config in dictConfig:
    ...
    for tag in dictConfig[config]['tag']:
        ...
        for m in meas_list:
            ...
            df_meas_filtered = df_meas[ df_meas['KIND_OF_PART'].str.contains('|'.join( dictMeas[m]['type_sel'] )) ] 
            ...
            summary_df[f'pass_{m}'] = np.where( ~df_meas['KIND_OF_PART'].str.contains('|'.join( dictMeas[m]['type_sel'] )) |
                                          (df_meas[m_db_name].between(thr_list[0],thr_list[-1])), True, False )
            ...
            # Filling Histogram
            histos[f'h1_{config}_{m}_{tag}'] = df_meas_filtered.plot.hist(column=m_db_name, bins=nbin, range=[xmin,xmax])
            ...
            if dictMeas[m]['DrawHisto']:
                histos[f'h1_{config}_{m}_{tag}'].get_figure().savefig(f'{plotdir}/h1_{config}_{m}_{tag}.pdf')
                plt.pyplot.close('all')
    
    
            outputfile.write(f"{xlab.ljust(25)}: min="+str(df_meas_filtered[m_db_name].min().round(3)).ljust(6)+" max="+str(df_meas_filtered[m_db_name].max().round(3)).ljust(6)
                             +" ==> Pass : "+str(len(summary_df[summary_df[f'pass_{m}']==False]) == 0) )
            outputfile.write("\n")
